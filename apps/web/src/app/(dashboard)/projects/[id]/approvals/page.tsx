...
export default function ProjectApprovalsPage() {
  ...
  async function loadApprovals() {
    ...
    try {
      ...
      setApprovalList(data.map((a) => ({ ...a, expanded: false })))
    } catch (err) {
      const mockApprovals: ApprovalWithDetail[] = [
        {
          id: "p1", project_id: projectId, workflow_id: "w1", agent_run_id: null,
        ...
        {
          id: "p2", project_id: projectId, workflow_id: "w1", agent_run_id: null,
        ...
        {
          id: "p3", project_id: projectId, workflow_id: "w1", agent_run_id: null,
  ...
  async function handleAction(approval: ApprovalWithDetail, action: "approved" | "rejected") {
    setIsActing(true)
    try {
      await approvalsApi.act(approval.id, action, action === "rejected" ? rejectionReason : undefined)
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-surface-900 dark:text-surface-100">Project Approvals</h1>
        <p className="text-sm text-surface-500 dark:text-surface-400 mt-1">
          Review and manage agent-proposed changes for this project
        </p>
      </div>
            ...
            <Card key={approval.id}>
              ...
              {approval.expanded && (
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider mb-2">Proposed Action</h4>
                      <p className="text-sm text-surface-700 dark:text-surface-300">{approval.proposed_action}</p>
                    </div>

                    {approval.expected_impact && (
                      <div>
                        <h4 className="text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider mb-2">Expected Impact</h4>
                    ...
                    {approval.command_preview && (
                      <div>
                        <h4 className="text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider mb-2">Command Preview</h4>
                    ...
                    {approval.rejection_reason && (
                      <div>
                        <h4 className="text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider mb-2">Rejection Reason</h4>
        ...
        {confirmDialog && (
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-3">
              <Button variant="ghost" onClick={() => { setConfirmDialog(null); setRejectionReason("") }}>Cancel</Button>
              <Button
